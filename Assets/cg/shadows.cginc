...
#if defined(_ALPHATEST_ON) || defined(_ALPHADITHERTEST_ON) || defined(_ALPHABLEND_ON) || defined(_ALPHAPREMULTIPLY_ON)
    #define UNITY_STANDARD_USE_SHADOW_UVS 1
#endif

uniform float4      _Color;
#if defined(_ALPHATEST_ON) || defined(_ALPHADITHERTEST_ON)
